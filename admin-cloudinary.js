...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const openProductModal = () => {
        ...
        // Eski checkbox ve grup gizleme kodlarını kaldır
        uploadedProductImageUrl = null;
    ...
    // Ürün form submit (FIREBASE + Cloudflare) - GÜNCELLENDİ
...
class ExcelManager {
    ...
    static async importProductsFromExcel(file) {
        // Bu satırda hata olabilir: loadingOverlay tanımlı değil
        // const loadingOverlay = document.getElementById('loading-overlay'); // Bu satırı kaldır
        // Yukarıda loadingOverlay tanımlandı

        loadingOverlay.style.display = 'flex'; // Burada kullan
        ...
        return new Promise((resolve, reject) => {
            ...
            reader.onload = async (e) => {
                try {
                    ...
                    loadingOverlay.style.display = 'none'; // Burada da kullan
